...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.vendor="pacroy" \
      org.label-schema.url="https://github.com/pacroy/docker-bookstack/" \
      org.label-schema.vcs-ref=$VCS_REF \
      org.label-schema.vcs-url="https://github.com/pacroy/docker-bookstack.git" \
